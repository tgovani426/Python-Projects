...
def formate_data(account):
    ...
    account_desrc = account["description"]
    account_country = account["country"]
    return f"{account_name}, a {account_desrc}, from {account_country}"


def check_answer(guess, a_follwers, b_followers):
    """ Takes the guess and follower counts and return if they got it right"""
...
while game_should_continue:
    ...
    # clear screen between the rounds
